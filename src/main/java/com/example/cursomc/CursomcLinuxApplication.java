...
public class CursomcLinuxApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat1 = new Categoria(null, "Inoformática");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "04671468611", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("33121264", "88928615"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardins",   "38081100", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Apto 203", "Centro", "38123000", cli1, c2);
